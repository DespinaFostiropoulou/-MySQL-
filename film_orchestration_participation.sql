...
CREATE TABLE `participation` (
  ...
  KEY `FK_Participation_Actor` (`ID_Actor`),
  KEY `FK_Participation_Film` (`ID_Film`),
  CONSTRAINT `FK_Participation_Actor` FOREIGN KEY (`ID_Actor`) REFERENCES `actor` (`ID_Actor`),
  CONSTRAINT `FK_Participation_Film` FOREIGN KEY (`ID_Film`) REFERENCES `film` (`ID_Film`)
